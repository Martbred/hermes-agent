...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("side", "Ask an ephemeral side question without continuing the main task", "Session",
               args_hint="<question>"),
    CommandDef("sidereturn", "No-op kept for backwards compatibility", "Session",
               aliases=("return", "closeside"), args_hint=""),
